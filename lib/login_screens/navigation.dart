...
import 'package:login_signup_email/test.dart';
import 'package:login_signup_email/user.dart';
import 'package:login_signup_email/login_screens/user_model.dart';
...
void selectedItem(BuildContext context, int index) {
  ...
  switch (index) {
    case 0:
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => const PeoplePage()));
      break;
    case 1:
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => const PeoplePage()));
